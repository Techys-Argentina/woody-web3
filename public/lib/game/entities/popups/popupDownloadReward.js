...
.defines(function() {
    ...
    EntityPopupDownloadReward = EntityPopup.extend({	
    	fadeIn:true,
    	animSheet: null,
		size: {x : 780 , y : 480 },		
		center:true,	
		...
		posConfirmBtn:{x:425,y:200},
		posCancelBtn:{x:600,y:200},
		pause:true,
		delay:5,
		...
		inicia: function(){
			this.parent();
			var esto=this;
			this.btn_confirm=ig.game.spawnEntity( Button, 0, 0, {animSheet: new ig.AnimationSheet( 'media/img/popups/exit-yes.png',145,145 ),	
				idParent:esto.id,
			...
			this.btn_cancel=ig.game.spawnEntity( Button, 0, 0, {animSheet: new ig.AnimationSheet( 'media/img/popups/exit-no.png',145,145),	
				idParent:esto.id,
